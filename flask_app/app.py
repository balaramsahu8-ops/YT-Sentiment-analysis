...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/balaram.sahu8/YT-Sentiment-analysis.mlflow")  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
def predict():
    ...
    try:
        ...
        # Convert sparse matrix to a dense DataFrame with feature names
        # (MLflow pyfunc models enforce an input schema that requires a DataFrame)
